...
export default function SermonCard({ titulo, fecha, predicador, descripcion, imagen, video }: SermonCardProps) {
  ...
  return (
    <div className="card flex flex-col md:flex-row">
      <div className="relative w-full md:w-52 h-48 md:h-auto flex-shrink-0 group">
        <Image
      ...
      <div className="p-5 flex-1">
        ...
        <div className="flex gap-2">
          {video && (
            <a href={video} target="_blank" className="px-4 py-2 bg-gray-100 rounded text-sm text-gray-600 hover:bg-primary hover:text-white transition-colors">
              <i className="fas fa-play mr-1"></i> Ver
            </a>
          )}
          <a href="#" className="px-4 py-2 bg-gray-100 rounded text-sm text-gray-600 hover:bg-primary hover:text-white transition-colors">
            <i className="fas fa-headphones mr-1"></i> Escuchar
          </a>
          <a href="#" className="px-4 py-2 bg-gray-100 rounded text-sm text-gray-600 hover:bg-primary hover:text-white transition-colors">
